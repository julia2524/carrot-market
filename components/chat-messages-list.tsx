    ...
    <div className="p-5 flex flex-col gap-5  min-h-screen">
      ...
      <form className="flex relative mt-5" onSubmit={onSubmit}>
        <input
          ...
          onChange={onChange}
          value={message}
          className="bg-transparent rounded-full w-full h-10 focus:outine-none px-5 ring-2 focus:ring-4 transition ring-neutral-200 focus:ring-neutral-50 border-none placeholder:text-neutral-400"
          type="text"
          name="message"
